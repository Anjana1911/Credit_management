...
//$conn1 = new mysqli('sql310.epizy.com','epiz_26607595','efkqUoUwFk', 'epiz_26607595_task1'); 
//or die ('Cannot connect to db');

    $result1 = $con->query("select name from users");

   // $conn2 = new mysqli('sql310.epizy.com','epiz_26607595','efkqUoUwFk', 'epiz_26607595_task1') 
//or die ('Cannot connect to db');
